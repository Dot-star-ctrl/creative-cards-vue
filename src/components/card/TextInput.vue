<template>
    <div class="text-input-wrapper" @mouseover="showOptions = true" @mouseout="showOptions = false">
        <section class="text-input-header">
            ...
            <button @click="removeSection()">x</button>
        </section>
...
export default {
    ...
    setup(props) {
        ...
        function changeHeight(value) {
            ...
            if((currentHeight === 100 && value === -100) || (currentHeight === 600 && value === 100)) return
